...
import { CheckCircle2, Loader2, XCircle, Download, Mail, Sparkles, Ticket, ArrowRight, MapPin, Clock, Calendar, Bus, User, Phone } from 'lucide-react';
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div id="printable-area">
            ...
            <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden mb-6">
              ...
              {/* Localizador Destacado - SEMPRE VISÍVEL */}
              <div className="p-8 bg-gradient-to-br from-blue-50 to-sky-50">
                <div className="text-center mb-6">
                  ...
                  <div className="text-5xl md:text-6xl font-black text-blue-600 mb-2 tracking-tight print:text-black">
                    {reserva?.localizador}
                  </div>
            ...
            {/* Informações de Suporte - VISÍVEL NA IMPRESSÃO */}
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
              <h3 className="font-bold text-gray-900 mb-4 text-lg">📞 Suporte GoodTrip</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-blue-600" />
                  <div>
                    <p className="text-sm text-gray-600">Telefone:</p>
                    <p className="font-bold text-gray-900">(93) 99143-6570</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-gray-900">suporte@goodtrip.com.br</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-6 no-print">
            <button
          ...
          {/* Aviso Email - NÃO APARECE NA IMPRESSÃO */}
          {reserva?.passageiro?.email && (
            <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl px-6 py-4 flex items-center gap-3 mt-6 no-print">
